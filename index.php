...
$dispatcher = FastRoute\simpleDispatcher(function (FastRoute\RouteCollector $r) {
    ...
    // x: cloud, pm, zip, ref
    $r->get('/docs/hugerte/1/react-{x}', fn () => new Redirect('https://github.com/hugerte/hugerte-docs/blob/main/integrations/react.md'));
    $r->get('/docs/hugerte/1/vue-{x}', fn () => new Redirect('https://github.com/hugerte/hugerte-docs/blob/main/integrations/vue.md'));
